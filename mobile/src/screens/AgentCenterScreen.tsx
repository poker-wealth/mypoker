...
const styles = StyleSheet.create({
  ...
  caption: { color: theme.dim, fontSize: 11, textTransform: 'uppercase', fontFamily: weight('800') },
  hero: { color: theme.success, fontSize: 30, fontFamily: weight('900') },
  dim: { color: theme.dim, fontSize: 11, fontFamily: weight('400') },
  sectionTitle: { color: theme.dim, fontSize: 11, textTransform: 'uppercase', fontFamily: weight('800') },
  listCard: { padding: 0, paddingHorizontal: space.md, gap: 0 },
  strong: { color: theme.success, fontSize: 20, fontFamily: weight('900') },
  figure: { color: theme.success, fontSize: 14, fontFamily: weight('700') },
  rightRow: { flexDirection: 'row', alignItems: 'center', gap: space.xs },
  rightCol: { alignItems: 'flex-end' },
  dot: { width: 8, height: 8, borderRadius: 4 },
  mono: { color: theme.text, fontSize: 11, fontFamily: weight('400') },
  ...
  detailValue: { color: theme.text, fontSize: 11, fontFamily: weight('400') },
  note: { color: theme.dim, fontSize: 11, lineHeight: 17, paddingHorizontal: space.xs, fontFamily: weight('400') },
  vipCard: { borderColor: 'rgba(245,185,59,0.3)', backgroundColor: 'rgba(245,185,59,0.1)' },
  vipTitle: { color: theme.jackpot, fontSize: 12, fontFamily: weight('800') },
  vipRow: { flexDirection: 'row', justifyContent: 'space-between', gap: space.sm },
  vipValue: { color: theme.jackpot, fontSize: 11, fontFamily: weight('800') },
  sparkAxis: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
  axisText: { color: theme.dim, fontSize: 10, fontFamily: weight('400') },
  linkHead: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  linkTitle: { color: theme.text, fontSize: 14, flex: 1, fontFamily: weight('700') },
  url: {
    ...
    paddingVertical: 6,
    color: theme.dim,
    fontSize: 10, fontFamily: weight('400') },
  ...
  warnText: { color: theme.jackpot, fontSize: 11, lineHeight: 17, fontFamily: weight('400') },
  centreCard: { alignItems: 'center' },
  becomeTitle: { color: theme.text, fontSize: 16, fontFamily: weight('800') },
  becomeBlurb: { color: theme.dim, fontSize: 12, lineHeight: 18, textAlign: 'center', fontFamily: weight('400') },
  track: {
    height: 6,
